...
function addProductPic(title, id, brand) {
    ...
    gridSubDiv.className = 'grid-item';
    gridSubDiv.style.display = 'flex';
    gridSubDiv.style.flexDirection = 'column';
    gridSubDiv.style.alignItems = 'center';
    gridSubDiv.style.justifyContent = 'center';
    ...
    gridSubDiv.appendChild(imgLink);
    gridSubDiv.appendChild(text);

    grid.appendChild(gridSubDiv);
}
